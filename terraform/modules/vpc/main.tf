...
# Create private subnets (for web app and database)
...
# Internet Gateway (allows public subnets to connect to internet)
...
# NAT Gateway (allows private subnets to connect to internet for updates)
...
# Route table for public subnets (routes traffic to internet)
